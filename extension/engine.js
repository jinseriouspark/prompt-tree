...
function stageFromHealth(health) {
  if (health <= 15) return { id: 0, name: "죽은 묘목", emoji: "🪵" };
  if (health <= 38) return { id: 1, name: "시드는 묘목", emoji: "🥀" };
  if (health <= 61) return { id: 2, name: "어린 소나무", emoji: "🌿" };
  if (health <= 84) return { id: 3, name: "푸른 소나무", emoji: "🌲" };
  return { id: 4, name: "노송 (老松)", emoji: "🌲" };
}

// 레벨(1~100) + 세밀한 단계 이름 (웹앱 tree.js 와 동일, 소나무 버전)
const LEVEL_NAMES = [
  [0, "죽은 묘목", "🪵"], [9, "마른 묘목", "🥀"], [17, "겨우 산 묘목", "🌱"],
  [25, "새순 묘목", "🌱"], [34, "어린 소나무", "🌿"], [43, "푸른 솔", "🌲"],
  [52, "제법 소나무", "🌲"], [61, "우거진 솔", "🌲"], [70, "든든한 소나무", "🌲"],
  [79, "솔향 가득", "🌲"], [88, "솔방울 맺힌 소나무", "🌰"], [95, "노송 (老松)", "🌲"],
];
